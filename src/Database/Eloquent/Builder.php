...
class Builder implements BuilderContract
{
    ...
    public function __construct(ClickhouseQueryBuilder $query)
    {
        $this->query = $query;
    }
    ...
    public function where($column, $operator = null, $value = null, $boolean = 'AND')
    {
        if ($column instanceof Closure && is_null($operator)) {
            $this->query->where(function(ClickhouseQueryBuilder $queryBuilder) use ($column) {
     ...
     * @return void
     */
    protected function addNewWheresWithinGroup(ClickhouseQueryBuilder $query, $originalWhereCount)
    {
     ...
     * @return void
     */
    protected function groupWhereSliceForScope(ClickhouseQueryBuilder $query, $whereSlice)
    {
    ...
    /**
     * @param  ClickhouseQueryBuilder  $query
     * @return $this
     */
    ...
    public function setModel(Model|\Illuminate\Database\Eloquent\Model $model)
    {
        $this->model = $model;
