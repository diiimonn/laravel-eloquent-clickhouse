...
/**
 * copy method from \Illuminate\Database\Eloquent\Model with some changes
 */
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, Stringable, UrlRoutable
{
    use Concerns\GuardsAttributes{fillableFromArray as fillableFromArrayTrait; }
    ...
    {
        $fillable = $this->fillableFromArrayTrait($attributes);
