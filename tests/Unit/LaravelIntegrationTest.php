...
use One23\LaravelClickhouse;
use PHPUnit\Framework\TestCase;
use Tests\Builder;
use Tests\BuilderException;
use Tests\Client;
use Tests\Connection;
use Tests\Expression;
use Tests\FileFromString;
use Tests\HttpTransport;
use Tests\NotSupportedException;
use Tests\Query;
use Tests\QueryStatistic;
use Tests\Result;
use Tests\Server;
...
class LaravelIntegrationTest extends TestCase
{
    ...
    {
        $config = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR . 'test.php';
    ...
    {
        $clickHouseServiceProvider = new LaravelClickhouse\ClickhouseServiceProvider(Container::getInstance());
        ...
        $this->assertInstanceOf(LaravelClickhouse\Database\Connection::class, $database);
    }
